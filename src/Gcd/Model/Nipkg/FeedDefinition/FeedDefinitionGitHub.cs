...
public record FeedDefinitionGitHub(GitRepoAddress Address, GitLocalBranch BrancName, GitUserName UserName, GitPassword Password, GitCommitterName CommitterName, GitCommiterEmail CommitterEmail) : IFeedDefinition
{
